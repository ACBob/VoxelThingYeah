...
void CDevConsole::Update()
{
	...
	m_pGui->Image(m_pGui->m_pBGTex, CVector(0, -1), CVector(m_pGui->m_vScreenDimensions.x, m_pGui->m_vScreenDimensions.y / 2) / m_pGui->m_iGuiUnit, CVector(0, 1), Colour(0.2,0.2,0.2));
