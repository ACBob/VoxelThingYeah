...
void CStatePlay::Enter()
{
	...
	m_invCreative = new CInventory({
		new CBlockItem(64, BLCK_STONE),
		new CBlockItem(64, BLCK_DIRT),
		new CBlockItem(64, BLCK_GRASS),
		new CBlockItem(64, BLCK_COBBLE),
		new CBlockItem(64, BLCK_PLANKS),
		new CBlockItem(64, BLCK_BEDROCK),
		new CBlockItem(64, BLCK_GLASS),
		new CBlockItem(64, BLCK_LOG	),
		new CBlockItem(64, BLCK_LEAVES),
		new CBlockItem(64, BLCK_WATERSRC),
		new CBlockItem(64, BLCK_LAVASRC),
		new CBlockItem(64, BLCK_COALORE),
		new CBlockItem(64, BLCK_IRONORE),
		new CBlockItem(64, BLCK_FLOWER),
		new CBlockItem(64, BLCK_SAND),
		new CBlockItem(64, BLCK_SANDSTONE),
		new CBlockItem(64, BLCK_BRICKS),
		new CBlockItem(64, BLCK_TALLGRASS),
		new CBlockItem(64, BLCK_MOSSYCOBBLE),
